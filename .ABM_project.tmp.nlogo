...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>total_system_co2_emitted_to_air</metric>
    <enumeratedValueSet variable="percentage_of_pipeline_filled_needed_to_start_building">
      <value value="70"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="number_of_companies">
      <value value="25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="yearly_budget">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="percentage_fixed">
      <value value="0"/>
      <value value="50"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="percentage_subsidy_for_pipeline">
      <value value="51"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
